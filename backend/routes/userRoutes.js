...
const { signup, sendOTP, verifyOTP,getNewArrivals,categoryWiseProducs, resetPassword, searchProducts, getSimilarProducts, filteredProducts, getReview, addReview } = require('../controllers/userController');
